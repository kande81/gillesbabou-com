<?php include('partials/header.php'); ?>
    ...
    <div class="main">
      ...
      <div class="main-text">
        Welcome to gillesbabou.com! These terms and conditions outline the rules
        and regulations for the use of gillesbabou.com's Website, located at
        www.gillesbabou.com. By accessing this website we assume you accept
        these terms and conditions. Do not continue to use gillesbabou.com if
        ...
        We employ the use of cookies. By accessing gillesbabou.com, you agreed
        to use cookies in agreement with the gillesbabou.com's Privacy Policy.
        ...
        Unless otherwise stated, gillesbabou.com and or its licensors own the
        intellectual property rights for all material on gillesbabou.com. All
        intellectual property rights are reserved. You may access this from
        gillesbabou.com for your own personal use subjected to restrictions set
        in these terms and conditions. You must not: Republish material from
        gillesbabou.com Sell, rent or sub-license material from gillesbabou.com
        Reproduce, duplicate or copy material from gillesbabou.com Redistribute
        content from gillesbabou.com This Agreement shall begin on the date
        ...
        certain areas of the website. gillesbabou.com does not filter, edit,
        publish or review Comments prior to their presence on the website.
        Comments do not reflect the views and opinions of gillesbabou.com,its
        ...
        applicable laws, gillesbabou.com shall not be liable for the Comments or
        for any liability, damages or expenses caused andor suffered as a result
        of any use of and or posting of and or appearance of the Comments on
        this website. gillesbabou.com reserves the right to monitor all Comments
        ...
        and represent that: You are entitled to post the Comments on our website
        ...
        unlawful material which is an invasion of privacy The Comments will not
        be used to solicit or promote business or custom or present commercial
        activities or unlawful activity. You hereby grant gillesbabou.com a
        ...
        the hyperlink compensates the absence of gillesbabou.com; and (d) the
        ...
        e-mail to gillesbabou.com. Please include your name, your organization
        ...
        of content on the linking party’s site. No use of gillesbabou.com's logo
