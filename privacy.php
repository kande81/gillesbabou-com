<?php include('partials/header.php'); ?>
    <div class="main" id="privacy">
      ...
      <div class="main-text">
        At gillesbabou.com, accessible from www.gillesbabou.com, one of our main
        priorities is the privacy of our visitors. This Privacy Policy document
        contains types of information that is collected and recorded by
        gillesbabou.com and how we use it. If you have additional questions or
        ...
        that they shared and/or collect in gillesbabou.com. This policy is not
        ...
        gillesbabou.com follows a standard procedure of using log files. These
        ...
        advertising partners of gillesbabou.com. Third-party ad servers or ad
        ...
        gillesbabou.com, which are sent directly to users' browser. They
        ...
        websites that you visit. Note that gillesbabou.com has no access to or
        control over these cookies that are used by third-party advertisers.

        <p class="legal-subhead">Third Party Privacy Policy</p>
        gillesbabou.com's Privacy Policy does not apply to other advertisers or
        ...
        <p class="legal-subhead">GDPR Data Protection Rights</p>
        ...
        <p class="legal-subhead">Children's Information</p>
        Another part of our priority is adding protection for children while
        using the internet. We encourage parents and guardians to observe,
        participate in, and/or monitor and guide their online activity.
        gillesbabou.com does not knowingly collect any Personal Identifiable
